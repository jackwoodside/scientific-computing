...
md"""
# Basic SIR Model
We will be using $$S$$, $$I$$ and $$R$$ to represent portions of the population, so $$S + I + R = 1$$. The system of differential equations is then
...
begin
	# Initial conditions
	infected = 20 # percentage initially infected
	p = [0.3, 0.16] # β, γ
	...
	nothing # don't print solution table
end
